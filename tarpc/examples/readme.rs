...
async fn main() -> io::Result<()> {
    ...
    let mut transport = tarpc::generic_transport::tcp::listen("localhost:0", Json::default).await?;
    ...
    let transport = tarpc::generic_transport::tcp::connect(addr, Json::default()).await?;
