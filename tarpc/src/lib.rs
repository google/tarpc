...
//!     let mut client = WorldClient::<context::Context>::new(client::Config::default(), client_transport).spawn();
//!
...
#![deny(missing_docs, warnings, unused, dead_code)]
...
#[non_exhaustive]
pub enum ClientMessage<Ctx, Req> {
